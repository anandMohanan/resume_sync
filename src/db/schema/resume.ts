import { index, pgTable, serial, text, time, timestamp } from "drizzle-orm/pg-core";
import { UserTable } from "./user";
import { sql } from "drizzle-orm";
export const ResumeTable = pgTable("user_resume", {
    resumeId: text("resume_id").primaryKey().default(sql`gen_random_uuid()::text`),
